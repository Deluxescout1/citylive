...
Item {
    ...
    property var shots: [
        { n:"village-world-13h-a85", mode:"world",   hour:13, age:0.85 },
        { n:"village-world-13h-a30", mode:"world",   hour:13, age:0.30 },
        { n:"village-world-13h-a55", mode:"world",   hour:13, age:0.55 },
        { n:"village-prim-13h-a85",  mode:"primary", hour:13, age:0.85 },
        { n:"village-prim-20h-a85",  mode:"primary", hour:20, age:0.85 },
        { n:"village-prim-13h-a30",  mode:"primary", hour:13, age:0.30 }
    ]
    property int idx: 0
    property int warm: 0
    property string outDir: "/tmp/claude-1000/-home-deluxescout/2db058e7-bff3-40ca-bb41-421151bb5164/scratchpad/village"
