...
Item { id: root; width: 854; height: 480
  property var shots: [
    {n:"karst-v0",  v:0, wind:8,  hour:13, fr:0.6},
    {n:"karst-v1",  v:1, wind:8,  hour:13, fr:0.6},
    {n:"karst-v2",  v:2, wind:8,  hour:13, fr:0.6},
    {n:"karst-haboob", v:0, wind:34, hour:13, fr:0.16},
    {n:"karst-dusk", v:0, wind:8, hour:19, fr:0.6}
  ]
  property int idx: 0
  property int warm: 0
  property double t0: 0
  property string outDir: "/tmp/claude-1000/-home-deluxescout/2db058e7-bff3-40ca-bb41-421151bb5164/scratchpad/karst"
  function arm(){
    var S=root.shots[root.idx], CYC=604800000, EPOCH=1783972450746;
    City.GROW_CYCLE=CYC; City.NOFETCH=true; City.FORCEEGG=null;
    City.FORCEBIOME='karst'; City.FORCEVARIANT=S.v;
    ...
    City.FORCEAGE=0.72; City.weather.code=0; City.weather.wind=S.wind; City.weather.temp=72;
  }
