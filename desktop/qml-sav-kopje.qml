...
// THE SAVANNA — the kopje's fig, and the spacing of the three acacia ranks.
// Nick photographed a fig hanging in mid-air above the saddle of a great kopje: the trunk was planted
// at `topY`, the summit of the WHOLE outcrop, while `ftx` stands it off-centre where the rock is lower.
//
...
//
// `qml6 qml-sav-kopje.qml -- woff=0 age=0.85 hour=13 variant=0 out=/some/dir`
...
Item {
    ...
    property string tag: arg("tag", "kopje")
    property string outDir: arg("out", "/tmp/claude-1000/-home-deluxescout/bb7d3665-023a-4a7c-beb2-9139002a7460/scratchpad/sav")
    ...
    function arm() {
        ...
        City.FORCEBIOME = 'savanna'; City.FORCEVARIANT = root.variant;
    ...
    Timer {
        ...
        onTriggered: {
            ...
            root.grabToImage(function (r) {
                r.saveToFile(root.outDir + "/sav-" + root.tag + "-w" + root.woff +
