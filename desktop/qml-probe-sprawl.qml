...
Item {
    ...
    function dump() {
        ...
        City.SLDBG={n:0,called:0};
        var vE=null;
        console.log("   SLDBG called="+City.SLDBG.called+" units="+City.SLDBG.n+" seaW="+City.seaW+" cityG="+City.cityG); console.log("   x -> " + (vE ? ("HIT x="+Math.round(vE.x)+" i="+vE.i+" since="+Math.round(vE.since/1000)+"s") : "null (intact)") + "   mtsCache.blown=" + (City.mtsCache?City.mtsCache.blown:"?"));
