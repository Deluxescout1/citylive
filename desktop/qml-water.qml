...
Item { id: root; width: 854; height: 480
  ...
  property string outDir: "/tmp/claude-1000/-home-deluxescout/2db058e7-bff3-40ca-bb41-421151bb5164/scratchpad/water"
  function arm(){
    ...
    City.FORCEAGE=0.72; City.weather.code=0; City.weather.wind=S.wind; City.weather.temp=50;
  }
