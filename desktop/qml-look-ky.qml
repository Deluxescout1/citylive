...
Item {
    ...
    property int hi: 0
    property int warm: 0
    property var ages: [0.05]   // FORCEAGE sweep: does the city GROW into what it becomes?
    property int ai: 0
    ...
    Timer {
        ...
        onTriggered: {
            ...
            root.grabToImage(function(res){
                res.saveToFile(root.outDir + "/ky-" + root.land + "-v" + root.variants[root.vi]
