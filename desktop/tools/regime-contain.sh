...
set -euo pipefail
cd "$(dirname "$0")/.."
BASE="now=1784255400000&clock=1784255400000&space=0.4&woff=0&noflights=1&nolivesky=1&nonewstv=1&nopartyfx=1&noeconfx=1&nosports=1"   # noflights/nolivesky/nonewstv/nopartyfx/noeconfx/nosports: post-v1.24 overlays (live aircraft, live sky, rooftop news jumbotrons, party-legacy visuals, hard-times street decay, sports district) the pre-v1.24 ref lacks — suppress them so the A/B stays byte-identical
