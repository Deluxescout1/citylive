...
// The wall-city as it GROWS, plus a night frame — the growth is the whole point of this land.
Item { id: root; width: 854; height: 480
  property var shots: [
    {n:"gc-age25", age:0.25, hour:13},{n:"gc-age50", age:0.50, hour:13},
    {n:"gc-age80", age:0.80, hour:13},{n:"gc-night",  age:0.80, hour:22}
  ]
  property int idx: 0
  property int warm: 0
  ...
  function arm(){
    ...
    City.FORCEAGE=S.age; City.weather.code=0; City.weather.wind=8; City.weather.temp=64;
  }
