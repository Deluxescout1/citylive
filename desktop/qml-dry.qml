...
// THE DRY RANGE at Nick's exact live state: life 358, age 0.125, primary 4K screen geometry.
Item { id: root; width: 1552; height: 874
  ...
  function arm(){
    ...
    var d=new Date(1783972450746+358*3600000+Math.round(0.125*3600000)); d.setHours(14,0,0,0);
    ...
    City.FORCEAGE=0.125; City.weather.code=0; City.weather.wind=6; City.weather.temp=79;
  }
  ...
  Timer { interval:340; running:true; repeat:true
    onTriggered:{ if(root.done){Qt.quit();return}
      ...
      root.grabToImage(function(r){ r.saveToFile(root.outDir+"/dry.png"); root.done=true; }); } }
}
