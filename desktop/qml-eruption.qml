...
Item {
    ...
    property int variant: 2                   // 1 = THE GREEN ISLAND (the one Nick screenshotted)
    ...
    function arm() {
        ...
        City.FORCEDIS = { type:"volcano", intensity:4, xf:0.42, w:58, seed:451, f:root.fs[root.fi] };
    }
    Canvas {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            root.grabToImage(function(res){
                var tag = "erupt-v" + root.variant + "-h" + root.hour + "-w" + root.woffList[root.woi]
