...
Item {
    ...
    property var shots: [
        { n:"fauna-plains", biome:"plains", variant:0, hour:13 },
        { n:"fauna-alpine", biome:"alpine", variant:0, hour:13 },
        { n:"fauna-arctic", biome:"arctic", variant:0, hour:13 }
    ]
    property int idx: 0
    property int warm: 0
    property string outDir: "/tmp/claude-1000/-home-deluxescout/2db058e7-bff3-40ca-bb41-421151bb5164/scratchpad/fauna"
