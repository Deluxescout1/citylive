...
// The hologram panels, day and night, on the MIDDLE monitor (where Nick sees the artifacts).
Item { id: root; width: 854; height: 480
  property var shots: [{n:"holo-day",hour:13},{n:"holo-night",hour:22}]
  property int idx: 0
  property int warm: 0
  ...
  function arm(){
    ...
    City.FORCEBIOME=null; City.FORCEVARIANT=null;
