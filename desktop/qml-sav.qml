...
Item { id: root; width: 854; height: 480
  property var shots: [
    {n:"savanna-v0",  v:0, wind:8,  hour:13, fr:0.6},
    {n:"savanna-v1",  v:1, wind:8,  hour:13, fr:0.6},
    {n:"savanna-v2",  v:2, wind:8,  hour:13, fr:0.6},
    {n:"savanna-haboob", v:0, wind:34, hour:13, fr:0.16},
    {n:"savanna-dusk", v:0, wind:8, hour:19, fr:0.6}
  ]
  property int idx: 0
  property int warm: 0
  property double t0: 0
  property string outDir: "/tmp/claude-1000/-home-deluxescout/2db058e7-bff3-40ca-bb41-421151bb5164/scratchpad/savanna"
  function arm(){
    var S=root.shots[root.idx], CYC=604800000, EPOCH=1783972450746;
    City.GROW_CYCLE=CYC; City.NOFETCH=true; City.FORCEEGG=null;
    City.FORCEBIOME='savanna'; City.FORCEVARIANT=S.v;
