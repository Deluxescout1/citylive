...
Item { id: root; width: 2269; height: 437
  property var shots: [
    { n:"mesa-hot",  wind:5,  cloud:8,  hour:13 },
    { n:"mesa-mild", wind:9,  cloud:15, hour:9 },
    { n:"mesa-night", wind:6,  cloud:10, hour:21 }
  ]
  property int idx: 0
  property int warm: 0
  property double t0: 0
  property string outDir: "/tmp/claude-1000/-home-deluxescout/48f22420-cb8d-47ef-8c39-d5207bc423d6/scratchpad/mesa"
  function arm(){
    var S=root.shots[root.idx], CYC=604800000, EPOCH=1783972450746;
    City.GROW_CYCLE=CYC; City.NOFETCH=true; City.FORCEEGG=null;
    City.FORCEBIOME='mesa'; City.FORCEVARIANT=0;          // pin the BASE look, the one that was null
    var d=new Date(EPOCH+25*CYC+Math.round(0.45*CYC)); d.setHours(S.hour,0,0,0);
    ...
    City.FORCEAGE=0.85;
    City.weather.code=0; City.weather.wind=S.wind; City.weather.temp=(S.n==='mesa-hot'?98:S.n==='mesa-mild'?70:74); City.weather.cloud=S.cloud;
  }
